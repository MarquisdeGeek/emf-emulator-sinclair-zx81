/*
 **
 ** EMF Machine : auto-gen : zx81
 **
 */
function emfzx81(options) {
  options = options || {};
  ...
  m.device.cpu.emulate = new zx81_z80_emulator(m.bus, options.cpu);
  m.device.cpu.disassemble = new zx81_z80_disassemble(m.bus, options.cpu);
  m.device.cpu.assemble = new zx81_z80_assemble(m.bus, options.cpu);
  m.device.memory = new zx81_memory(m.bus, options.memory);
  m.device.display = new zx81_display(m.bus, options.display);
  m.device.iorq = new zx81_iorq(m.bus, options.iorq);
  m.device.ula = new zx81_ula(m.bus, options.ula);
  ...
  m.bus.clock = {};
  m.clock = {};
  m.clock.cpu = new zx81_clock_cpu(m, options);
  m.bus.clock.cpu = m.clock.cpu;
  m.clock.timer = new zx81_clock_timer(m, options);
